...
struct TrebleClefBoogieWoogie: View {
                ...
                .background(
                    GeometryReader { geo in
                        ...
                        Group{
                            ...
                            QuarterNote()
                                .position(x: 185, y: 142)
                                
                                QuarterNote()
                                    .position(x: 233, y: 142)
                                
                                QuarterNote()
                                    .position(x: 233, y: 164)
                        }
